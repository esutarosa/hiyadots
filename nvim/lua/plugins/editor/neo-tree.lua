return {
	...
	config = function(_, opts)
		...
		vim.api.nvim_create_autocmd("FileType", {
			...
			callback = function()
				vim.wo.winhighlight =
					"Normal:NeoTreeNormal,NormalNC:NeoTreeNormalNC,EndOfBuffer:NeoTreeEndOfBuffer,SignColumn:NeoTreeSignColumn,CursorLine:NeoTreeCursorLine,WinSeparator:NeoTreeWinSeparator,WinBar:NeoTreeNormal,WinBarNC:NeoTreeNormalNC"
				vim.cmd("setlocal fillchars=eob:\\ ")
			end,
		})
	end,
